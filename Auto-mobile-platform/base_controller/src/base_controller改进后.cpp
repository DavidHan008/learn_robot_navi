...
unsigned char d_speed_data[5]={0}; 
...
d_speed_data[0]=speed_data[2];
d_speed_data[1]=speed_data[3];
d_speed_data[2]=speed_data[6];
d_speed_data[3]=speed_data[7];
d_speed_data[4]=speed_data[8];


for(int i=0;i<5;++i)
{
std::cout<<(int)d_speed_data[i]<<std::endl;
}
